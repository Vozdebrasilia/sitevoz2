...
const LOCAL_ADS: Record<string, LocalAd> = {
  ...
  janga: {
    ...
    title: 'Janga Praia',
    subtitle: '#2 melhor restaurante de Maceió · lagosta e camarão à beira-mar',
    address: 'Av. Silvio Carlos Viana, 1731 · Maceió/AL',
    ...
    whatsappLabel: 'Reservar',
    gradient: 'from-cyan-950/90 via-teal-900/70 to-cyan-800/35',
    badge: '#2 MACEIÓ',
  },
  ritz: {
