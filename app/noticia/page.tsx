...
export default function DynamicNoticiaPage() {
  ...
  useEffect(() => {
    ...
    async function loadPost() {
      ...
      try {
        ...
        console.error('Error loading dynamic post:', err);
      } finally {
        setIsLoading(false);
      }
    }
      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <main className="pt-24 pb-12 text-center">
          <h1 className="text-2xl font-bold text-gray-700">
            Notícia não encontrada ou ainda está sendo publicada.
          </h1>
  ...
  const categoria = post.category || 'Notícia';
  const categoriaSlug = post.categoryslug || 'distrito-federal';
                          ...
                          >
                            ...
                            <div className="flex-1">
                              ...
                              <span className="text-xs text-gray-500">
                                {new Date(r.published_at || r.created_at).toLocaleDateString('pt-BR')}
                              </span>
                            </div>
                          </Link>
                        );
